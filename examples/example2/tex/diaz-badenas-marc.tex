...
Donada la matriu
\[
   A=\begin{pmatrix}{*{3}r} -1 & 2 & 4\\ -1 & -4 & -4\\ -1 & 1 & 3\end{pmatrix}\,,
\]
\begin{apartats}
...
\[
  \left.\aligned - 3 x + m y - z &= -4 \\ 3 x + y + z &= 4 \\ x + 2 y - 3 z &= m + 4 \endaligned\;\right\}\,,
\]
\begin{apartats}
...
\begin{tabular}{|L{3cm}{1.5cm}|L{7cm}{1.5cm}|}
\hline
$m=-1$ & $\left.\aligned x &= - z + 1 \\ y &= 2 z + 1 \endaligned\;\right\}$\\
\hline
\end{tabular}
\end{center}
\end{solucio}
...
\begin{pmatrix}{*{1}r} 4\\ -5\\ -2\end{pmatrix} + 
...
\[
  x - 2 = \frac{y + 3}{3} = \frac{z + 3}{-1}\qquad\text{i}\qquad \left.\aligned - x + 2 y - z &= -6 \\ - 2 x + 3 y - z &= -8 \endaligned\;\right\}\,.
\]
\begin{apartats}
...
\hline
$d=\displaystyle \frac{5 \sqrt{6}}{3}$ & $2 x - y - z = 10$ \\
\hline
\end{tabular}
\end{center}
\end{solucio}
...
Canonica(-12,14,-11,9);
Parabola((1,-1),(4,2),x=10,y=10);
clip((-12,-11)--(14,-11)--(14,9)--(-12,9)--cycle);
\end{asy}
\end{center}
\caption{Representació gràfica de la cònica}
\end{figure}
...
\hline
$\cal R'=\left\{(1,-1);\deufrac{1}{\sqrt{2}}(1,-1),\deufrac{1}{\sqrt{2}}(1,1)\right\}$\hspace{2cm} $\displaystyle y' = \frac{x'^2}{12 \sqrt{2}}$  \hspace{2cm} Paràbola\\
\hline
\end{tabular}
\end{center}
\end{solucio}
